(function() {
    ...
    angular
        .module('bookingApp.servicesPage', [])
        .controller('BookableServicesPagePageController', BookableServicesPagePageController);

    BookableServicesPagePageController.$inject = ['DataService']

    function BookableServicesPagePageController(DataService) {
        var vm = this;
